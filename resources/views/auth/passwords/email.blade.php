...
@section('content')
    <div class="d-flex flex-column flex-root">
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            <a href="/metronic8/demo19/../demo19/index.html" class="d-block d-lg-none mx-auto py-20">
                <img alt="Logo" src="/metronic8/demo19/assets/media/logos/default.svg" class="theme-light-show h-25px" />
                <img alt="Logo" src="/metronic8/demo19/assets/media/logos/default-dark.svg"
            ...
            <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    <div class="d-flex flex-stack py-2">
                        <div class="me-2">
                            <a href="/metronic8/demo19/../demo19/authentication/layouts/fancy/sign-in.html"
            ...
            <div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat"
                style="background-image: url(/metronic8/demo19/assets/media/auth/bg11.png)"></div>
        </div>
    </div>
    {{-- <section class="h-100">
