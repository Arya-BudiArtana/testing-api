...
<head>
    ...
    <title>My App - Konfirmasi Lupa Kata Sandi</title>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td style="padding:0;Margin:0;font-size:0px"
                                                                    align="center"><img
                                                                        src="https://preview.keenthemes.com/metronic8/demo19/assets/media/logos/default.svg"
                                                                        alt="Logo My Home Desa Wisata"
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:12px"
                                                                        title="Logo My Home Desa Wisata" width="282">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;border-top:1px solid #ffffff;border-right:1px solid #ffffff;border-left:1px solid #ffffff;width:600px;border-bottom:1px solid #ffffff"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Anda menerima email ini karena sistem menerima
                                                                        permintaan reset kata sandi yang terhubung ke
                                                                        akun My App Anda, silahkan
                                                                        tekan tombol
                                                                        dibawah
                                                                        ini untuk melakukan reset ulang kata sandi Anda
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0"><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#26A4D3;background:#009141;border-width:0px;display:inline-block;border-radius:50px;width:auto"><a
                                                                            href="{{ $link }}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:14px;border-style:solid;border-color:#009141;border-width:15px 30px 15px 30px;display:inline-block;background:#009141;border-radius:50px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:17px;width:auto;text-align:center">Reset
                                                                            Kata Sandi</a></span></td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#555555;font-size:15px">
                                                                        Jika link diatas tidak bekerja, Anda dapat
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#555555;font-size:15px">
                                                                        Abaikan pesan ini jika permintaan pergantian
                                                                        kata sandi bukan dari Anda
                                                                    </p>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Email ini ditujukan
                                                                        untuk {{ ucWords($name) }} karena
                                                                        Email anda terdaftar pada Aplikasi
                                                                        MY App<br></p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <strong>GanaDev
                                                                            Com</strong>, All Rights Reserved.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#666666;font-size:12px">
                                                                        my app adalah nama bisnis
                                                                        terdaftar yang
                                                                        dikelola oleh PT Ganadev Multi Solusi (GanaDev
                                                                        Com) dan
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#666666;font-size:12px">
                                                                        Seluruh konten dan publikasi email ini
                                                                        dikelola oleh <strong>PT Ganadev Multi
                                                                            Solusi</strong> (GanaDev Com).
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td
                                                                    ...
                                                                    <div style="text-align:center"><a
                                                                            href="mailto:info@myhomedesawisata.com?subject=Request Unsubscribe"
                                                                        ...
                                                                        <span>·</span>
                                                                        <a href="https://myhomedesawisata.com/help/privacy-policy"
                                                                            ...
                                                                            Policy</a>
                                                                        <span>·</span>
                                                                        <a href="https://myhomedesawisata.com/help/term-and-condition"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#666666;font-size:12px">
                                                                            Terms
                                                                            & Conditions</a>
                                                                        <span>·</span>
                                                                        <a href="https://myhomedesawisata.com/help/faqs"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#666666;font-size:12px">
                                                                            FAQ's</a>
                                                                    </div>
                                                                </td>
